...
export default function LocationPicker({ value, onChange, disabled = false, className = '' }: { value: string; onChange: (value: string) => void; disabled?: boolean; className?: string }) {
  ...
  return <div className="relative">
    <input
      ...
      autoComplete="off"
    />
    {query.length >= 2 && !disabled && suggestions.length > 0 && (
